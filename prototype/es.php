...
<body class="home" data-region="emea" data-channelcode="tavernadelasaldirect">
        ...
        <form action="#" class="ibe" method="get" data-region="emea" data-channelcode="tavernadelasaldirect" data-widget="property_check_availability" target="_blank">
            <fieldset>
                <div class="field">
                    ...
                    <a class="offers" href="popups/offer-es.html" title="Ventajas" rel="modal:open">Ventajas</a>
                </div>
            </fieldset>
        </form>
    ...
    <a href="popups/offer-es.html" class="advantage-btn" title="Ventajas" rel="modal:open">Ventajas</a>
            ...
            <div class="row">
                <div class="column">
                    ...
                    <div class="copy">
                        ...
                        <p>El coste es de 20,00€/noche (IVA incluido).</p>
