...
<body class="home" data-region="emea" data-channelcode="tavernadelasaldirect">
        ...
        <form action="#" class="ibe" method="get" data-region="emea" data-channelcode="tavernadelasaldirect" data-widget="property_check_availability" target="_blank">
            <fieldset>
                <div class="field">
                    ...
                    <a class="offers" href="popups/offer-fr.html" title="Avantages" rel="modal:open">Avantages</a>
                </div>
            </fieldset>
        </form>
    ...
    <a href="popups/offer-fr.html" class="advantage-btn" title="Avantages" rel="modal:open">Avantages</a>
            ...
            <div class="row">
                <div class="column">
                    ...
                    <div class="copy">
                        ...
                        <p>Le prix est de 20€ par nuit.</p>
